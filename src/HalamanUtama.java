...
/**
 *
 * @author Choco Cslon Presiden RI
 */
public class HalamanUtama extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LEONIDAS INTERNATIONAL");
        jLabel1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Unt.png"))); // NOI18N
        ...
        PanelInduk.setBackground(new java.awt.Color(34, 49, 63));
        PanelInduk.setLayout(new java.awt.BorderLayout());

        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Copyright © 2020 - Choco Calon Presiden RI ");
        PanelInduk.add(jLabel3, java.awt.BorderLayout.PAGE_END);

        getContentPane().add(PanelInduk, java.awt.BorderLayout.CENTER);

        jMenuBar1.setBackground(new java.awt.Color(34, 167, 240));

        jMenu1.setBackground(new java.awt.Color(153, 153, 255));
        jMenu1.setText("Menu");

        miForm.setText("Beranda");
